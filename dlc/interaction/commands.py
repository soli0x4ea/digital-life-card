...
# ═══════════════════════════════════════════════════════════════
# v3.0: Narrative rendering stubs — v3.0 state machine does not
# output NL; narrative assembly is handled by dlc/narrative/assembly.py
# ═══════════════════════════════════════════════════════════════

def render_event(event_id, narratives_cfg, severity="warning", state=None, before_state=None):
    """v3.0 stub — narrative assembly handles text output externally."""
    return ""

def render_command_narrative(cmd_id, state, narratives_cfg, **extra):
    """v3.0 stub — narrative assembly handles text output externally."""
    return ""

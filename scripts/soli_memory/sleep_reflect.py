...
WORKBUDDY_MEMORY = Path(os.path.expandvars(r"C:\Users\济南府\WorkBuddy\Claw\.workbuddy\memory\MEMORY.md"))
...
def build_reflect_prompt(episodes: List[Dict], claims: List[Dict], longterm: str) -> str:
    ...
    lines.append("")
    lines.append("**重要**：你只做建议，不执行任何文件修改。输出写入 reflections.md 供少爷审阅。")
